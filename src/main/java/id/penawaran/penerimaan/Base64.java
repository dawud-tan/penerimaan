 ...
 * <li>v2.3.5 - Fixed bug in encodeFromFile where estimated buffer size was
 * wrong for files of size 31, 34, and 37 bytes.</li>
...
/* ********  E N C O D I N G   M E T H O D S  ******** */
     ...
     * throw an java.io.IOException. <b>This is new to v2.3!</b>
    ...
    /**
     * Similar to encodeBytes(byte[]) but returns a byte array instead of
